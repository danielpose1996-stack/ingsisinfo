      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-16">
        ...
        >
          <h1 className="text-4xl md:text-5xl font-black tracking-tight text-foreground uppercase italic leading-tight">
            ...
            <span className="text-[#1E3A8A]">y Soluciones Informáticas</span>
          </h1>
          <div className="w-24 h-1.5 bg-[#1E3A8A] mx-auto rounded-full" />
        </motion.div>
        ...
        >
          <motion.div variants={itemVariants}>
            <GlassCard className="p-8 h-full border-t-4 border-t-[#1E3A8A] relative overflow-hidden group">
              ...
              <h3 className="text-xl font-bold mb-4 flex items-center gap-2 text-[#1E3A8A] italic">
        ...
        <div className="space-y-10 pt-8">
          ...
          >
            <h2 className="text-2xl font-bold uppercase tracking-widest italic flex items-center gap-3">
              <span className="w-2 h-8 bg-gradient-to-b from-[#1E3A8A] to-blue-900 rounded-full" />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              <motion.div
                ...
                viewport={{ once: true }}
              >
                <GlassCard className="p-6 h-full hover:border-[#1E3A8A]/30 transition-all group">
